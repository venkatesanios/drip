...
class _FertilizerWidgetState extends State<FertilizerWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Stack(
        children: [
          if(site[widget.siteIndex]['Agitator'].length > 1 )
            Positioned(
              top: 5,
              left: 20,
              child: Row(
                children: [
                  for(var ag = 0;ag < site[widget.siteIndex]['Agitator'].length;ag++)
                    Column(
                      children: [
                        Row(
                          children: [
                            SizedBox(
                              ...
                              child: SvgPicture.asset(
                                'assets/images/${getAgitatorStatus(site[widget.siteIndex]['Agitator'][ag]['Status'])}.svg',
                              ),
                            ),
                            SizedBox(width: 20,)
                          ],
                        ),
                        Text('${site[widget.siteIndex]['Agitator'][ag]['Name']}',style: TextStyle(fontSize: 10),),
                      ],
                    )
                ],
              ),
