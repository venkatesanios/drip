...
class FiltrationSiteFalse extends StatefulWidget {
...
class _FiltrationSiteFalseState extends State<FiltrationSiteFalse> with SingleTickerProviderStateMixin{
                        ...
                        if(site[widget.siteIndex]['PrsIn'] != '-')
                          Positioned(
                            ...
                            child: Container(
                              ...
                              child: Center(
                                  child: Text('Pressure In : ${getPressureValue(payloadProvider.units[1]['value'].toString(), site[widget.siteIndex]['PrsIn'].toString())} ${payloadProvider.units[1]['value']}',style: TextStyle(color: Colors.white,fontSize: 12),)
                              ),
                            ),
                          ),
                        if(site[widget.siteIndex]['PrsOut'] != '-')
                          Positioned(
                            ...
                            child: Container(
                              ...
                              child: Center(
                                  child: Text(' Pressure out : ${getPressureValue(payloadProvider.units[1]['value'].toString(), site[widget.siteIndex]['PrsOut'].toString())} ${payloadProvider.units[1]['value']}',style: TextStyle(color: Colors.white,fontSize: 12),)
                              ),
                            ),
                          ) ,
                      ],
