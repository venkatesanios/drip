...
//
//
// class WeatherScreenExternal extends StatefulWidget {
//    WeatherScreenExternal(
//       {Key? key,
//         required this.userId,
//         required this.controllerId,
//         this.deviceID,required this.initialIndex,required this.menuId});
//    final userId, controllerId, deviceID, menuId;
//    var initialIndex = 0;
//   @override
//   _WeatherScreenExternalState createState() => _WeatherScreenExternalState();
// }
//
// class _WeatherScreenExternalState extends State<WeatherScreenExternal> {
...
//         child: Scaffold(
//           appBar: AppBar(title: Text('Weather Station', style: TextStyle(color: Theme.of(context).primaryColor,fontWeight: FontWeight.bold)), automaticallyImplyLeading: false,),
//           body: Center(
//             child: Container(
