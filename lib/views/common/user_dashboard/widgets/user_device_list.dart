...
import '../../../../view_models/device_list_view_model.dart';
...
class UserDeviceList extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final int userType = userRole=='Dealer'? 2 : 3;
    return ChangeNotifierProvider(
      create: (_) {
        final viewModel = DeviceListViewModel(Repository(HttpService()),
            userId, customerId, productStockList.length, userType);
        viewModel.loadDeviceList(1);
        return viewModel;
      },
      child: Consumer<DeviceListViewModel>(
