...
class _DealerScreenControllerState extends State<DealerScreenController> {
  ...
  int selectedIndex = 0;
  int hoveredIndex = -1;
  final List<String> menuTitles = ['Dashboard', 'Products'];
  final List<Widget?> _pages = List.filled(2, null);
      ...
      child: Consumer<NavRailViewModel>(
        builder: (context, viewModel, _) {
          return Scaffold(
            ...
            appBar: AppBar(
              leading: widget.fromLogin? Padding(
    ...
    return Padding(
      ...
      child: Row(
        ...
        children: [
          ...
          if(selectedIndex==1 && sWidth > 1030)...[
            const Spacer(),
            Container(
              width: 400,
              height: 40,
