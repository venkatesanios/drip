        ...
        builder: (context, viewModel, _) {
          ...
          return Scaffold(
              ...
              body: viewModel.isLoading
                  ? Center(child: LoadingIndicator(indicatorType: Indicator.ballPulse))
                  : DataTable2(
                ...
                List<DataRow>.generate(viewModel.productInventoryList.length, (index) => DataRow(cells: [
                  ...
                  DataCell(Center(child: widget.userName==viewModel.productInventoryList[index].latestBuyer? Text('-'):Text(viewModel.productInventoryList[index].latestBuyer, style: const TextStyle(fontSize: 12)))),
