                    ...
                    child: Column(
                      ...
                      children: [
                        const ListTile(
                          ...
                          subtitle: Text(
                            'Please select category and model, then enter the device ID, warranty period, and manufacturing date before adding to stock.',
                            ...
                            child: TextButton(
                              ...
                              child: const Row(
                                ...
                                children: [
                                  Icon(Icons.add),
                                  SizedBox(width: 8),
                                  Text('ADD STOCK', style: TextStyle(fontSize: 12)),
                                ],
                              ),
                            ),
                          ),
